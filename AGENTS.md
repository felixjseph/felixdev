...
- The experience section uses the official supplied CV as its factual source. Keep the animated sticky “Built to adapt” introduction, then present Softpoint Solutions and Knowles Corporation as an open, card-free vertical timeline with company, role, period, location/work mode, concise factual paragraphs, and role-specific skill chips. A single hairline connects circular milestones: its fill follows section scroll on every viewport and may track pointer height on fine-pointer devices. It must remain decorative, theme-aware, transform-only, fully drawn under reduced motion, and independent of content visibility. Follow the timeline with the approved core-competency chips and no divider above them; do not substitute the unrelated companies shown in layout-reference screenshots.
