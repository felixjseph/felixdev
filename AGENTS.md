...
- The experience section uses the official supplied CV as its factual source. Keep the animated sticky “Built to adapt” introduction, then present Softpoint Solutions and Knowles Corporation as compact timeline entries with dates, location/work mode, short evidence-led highlights, and role-specific skill chips. Follow them with the approved core-competency chips; do not substitute the unrelated companies shown in layout-reference screenshots.
