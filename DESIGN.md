...
- Skills: place the restored “A broad stack. One clear standard.” chapter at the dedicated `#skills` anchor, after the Friction to Flow About section. Use one seamless icon-only monochrome rail rather than grouped rows, colored technology pills, or the superseded Signal Map. The rail pauses for hover/focus and becomes static and horizontally scrollable under reduced motion.
