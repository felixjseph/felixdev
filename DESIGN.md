...
- Skills: place the focused “Daily drivers. Built for the work.” chapter at the dedicated `#skills` anchor, after the Friction to Flow About section. Use one seamless icon-only monochrome rail for Claude Code, Codex, Cursor, Visual Studio Code, Zapier, and Google Gemini rather than grouped rows, labels, colored technology pills, or the superseded Signal Map. Give every official brand shape the same circular hover target and restrained inversion; pause on hover/focus and become static and horizontally scrollable under reduced motion.
