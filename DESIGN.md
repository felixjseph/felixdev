...
- Skills: place the focused “Daily drivers. Built for the work.” chapter at the dedicated `#skills` anchor, after the Friction to Flow About section. Use one seamless monochrome tool rail for Claude Code, Codex, Cursor, VS Code, Zapier, and AI workflows rather than grouped rows, colored technology pills, or the superseded Signal Map. Pair official marks with structured names, use text-only wordmarks when an official mark is unavailable, pause on hover/focus, and become static and horizontally scrollable under reduced motion.
