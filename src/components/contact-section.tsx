      ...
      <div className="section-shell contact-shell">
        <div className="contact-heading">
          ...
          <div className="contact-intro">
            <p>Have a project or workflow that deserves a better system? Tell me about it.</p>
            <a className="contact-email-button" href={`mailto:${siteConfig.publicContact.email}`}>
